...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        ResourceEntity anna = saveEmployee("Anna Nowak", "Kasjerka, obsługa klienta",
                new BigDecimal("32.00"),
                employeeMetadata("Kasjerka", "SALES", "UOP", 40, "32.00"));
        ResourceEntity piotr = saveEmployee("Piotr Wiśniewski", "Magazynier z uprawnieniami na wózek",
        ...
        saveEmployee("Tomasz Zieliński", "Sprzedawca, dział elektronika",
        ...
        saveInactiveEmployee("Ewa Kamińska", "Specjalistka HR (urlop macierzyński)",
        ...
        seedShift(user, anna, base.plus(7, ChronoUnit.HOURS),
                ...
                shiftMetadata("MORNING", "Obsługa kasy nr 2", ""));
        seedShift(user, piotr, base.plus(15, ChronoUnit.HOURS),
                RequestStatus.CONFIRMED,
                shiftMetadata("EVENING", "Rozładunek dostawy", "Magazyn A"));
        seedShift(user, jakub, base.plus(15, ChronoUnit.HOURS),
                RequestStatus.PENDING,
                shiftMetadata("EVENING", "Przegląd instalacji", "Hala A"));
        seedShift(user, marta, base.plus(7, ChronoUnit.HOURS),
                RequestStatus.CONFIRMED,
                shiftMetadata("MORNING", "Wsparcie użytkowników", "Biuro główne"));
